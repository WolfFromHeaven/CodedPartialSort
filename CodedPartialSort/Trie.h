...
/*class reverseSorter {
 private:
  unsigned int length;
 public:
 reverseSorter( unsigned int _length ): length( _length ) {}
  bool operator()( const std::pair<unsigned char*,unsigned int> keyl, const std::pair<unsigned char*,unsigned int> keyr ) { return cmpKeyInverse( keyl, keyr, length ); }
};*/
...
class reverseSorter {
 ...
 public:
 reverseSorter( unsigned int _length ): length( _length ) {}
  bool operator()( const unsigned char* keyl, const unsigned char* keyr ) { return cmpKeyInverse( keyl, keyr, length ); }
};

struct KeyOrder {
  bool operator()(const unsigned char* keyA, const unsigned char* keyB) const {
